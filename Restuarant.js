...
//headmenu
function getLogo() {
  menuLogo.innerHTML += `<a href=""><img src="/RestuarantProject/image/bg-01.png" alt="" class="w-16 md:w-32 lg:w-48" /><h3>Food&Drink</h3></a> `;
}
getLogo();
function getBar() {
  menuBar.innerHTML += `
...
function getCon() {
  const cont = [
    {
      img: "/RestuarantProject/image/breads-1867459_640.jpg",
      title: "Bread",
    },
    {
      img: "/RestuarantProject/image/b1.webp",
      title: "Dissert",
    },
    {
      img: "/RestuarantProject/image/drink1.webp",
      title: "Drink",
    },
    {
      img: "/RestuarantProject/image/pasta-1181189_1280.jpg",
      title: "Food",
    },
  ];
  var txt = "";
...
//showProduct
const url = "http://192.168.100.8:5500/RestuarantProject/Restuarant.json";
